...
{/if}
	...
	{foreach $product['customizedDatas'] as $customizationPerAddress}
		{foreach $customizationPerAddress as $customizationId => $customization}
			...
			{capture name="recipientPdf"}{$smarty.const._PS_SCENE_IMG_DIR_}ndkcf/pdf/{$order->id_customer|intval}/{$product['id_product']|intval}_{$customizationId}_WEB{$order->reference}.pdf{/capture}
