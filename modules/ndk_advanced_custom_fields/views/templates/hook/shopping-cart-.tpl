			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<iframe class="embed-responsive-item" width="100%" scrolling="no" style="height: 70vh; overflow-y: hidden; border: none;" id="frame-render" src="" onload="aluclass_resizeIframe(this)"></iframe>
					</div>
				</div>
			</div>
		</div>
