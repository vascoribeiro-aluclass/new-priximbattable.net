...
<head>
    ...
    <link rel="stylesheet" href="{$cssPath|escape:'html':'UTF-8'}rangeslider.css">
    ...
    <script src="{$jsPath|escape:'html':'UTF-8'}rangeslider.min.js"></script>
...
<body>
    ...
    <main class="pt-4">
       ...
       m     {include file="$tplPath/admin/_partials/alerts.tpl"}
