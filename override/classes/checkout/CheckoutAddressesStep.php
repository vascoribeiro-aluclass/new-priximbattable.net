...
class CheckoutAddressesStep extends CheckoutAddressesStepCore
{
    ...
    public function handleRequest(array $requestParams = [])
    {
        ...
        if (isset($requestParams['confirm-addresses'])) {
            ...
            /// Desenvolvimento Vasco Passa passo se tiver coolect selecionados
                $this->logged_in = $this
                ->getCheckoutProcess()
                ->getCheckoutSession()
                ->customerHasLoggedIn();

                if ($this->logged_in && !$this->getCheckoutSession()->getCustomer()->is_guest && !$this->step_is_complete) {
                $this->step_is_reachable = true;
                $requestParams['confirm-addresses'] = true;
                }
            /// Desenvolvimento Vasco Passa passo se tiver coolect selecionados
