...
if ($periodo == "s") {
	// $data_fim = "2022-02-06 23:59:59";
	// $data_inicio = "2022-01-31 00:00:00";
...
$select_sql = "SELECT * FROM ps_orders WHERE date_add>='$data_inicio' AND date_add<='$data_fim' AND id_order<>'46786'";
...
while ($pedidos = $select_exec->fetch_array()) {
	...
	while ($produtos = $exec_produtos->fetch_array()) {
		...
		$sql_categoria = "SELECT x.* FROM (SELECT * FROM ps_product WHERE id_product='$id_product_now' UNION ALL SELECT * FROM ps_ndk_product WHERE id_product='$id_product_now') x";
		...
		if ($categoria["id_category_default"] == $id_cat_ndk) {
			...
			$sql_nome_prod = "SELECT x.name FROM (SELECT name FROM ps_product_lang WHERE id_product='$id_product_now' UNION SELECT name FROM ps_ndk_product_lang WHERE id_product='$id_product_now') x";
			...
			$sql_id_produto = "SELECT x.* FROM (SELECT * FROM ps_product_lang WHERE id_lang='$id_lang' AND name='$nom' UNION SELECT * FROM ps_ndk_product_lang WHERE id_lang='$id_lang' AND name='$nom') x";
			...
			$sql_id_cat_deste_prod = "SELECT x.id_category_default FROM (SELECT id_category_default FROM ps_product WHERE id_product='$id_deste_produto_vez' UNION SELECT id_category_default FROM ps_ndk_product WHERE id_product='$id_deste_produto_vez') x";
