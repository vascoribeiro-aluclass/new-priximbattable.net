...
if ($periodo == "s") {
	$data_fim = "2021-09-28 23:59:59";
	$data_inicio = "2021-09-20 00:00:00";
...
while ($pedidos = $select_exec->fetch_array()) {
	...
	while ($produtos = $exec_produtos->fetch_array()) {
		...
		echo $i_exec." | ORDER ".$id_order_now." - PROD ".$id_product_now." - QTD ".$produtos["product_quantity"]." - CAT ".$id_categoria." - NOM ".$nom." - VALOR ".$produtos["total_price_tax_incl"]."<br>";
		$i_exec++;
