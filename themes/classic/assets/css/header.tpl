...
<div class="container-fluid">
   ...
   <img src="/img/soldes/rentree1.png" alt="" style="float:left;padding:0;" class="img-fluid" />
   <img src="/img/soldes/rentree2.png" alt="" style="float:left;padding:0; width:400px; height: 80px;" class="img-fluid" />
   <a href="https://priximbattable.net/101-bonnes-affaires"><img src="/img/soldes/rentree3.png" alt="" style="float:left;padding:0; width:400px; height: 80px;" class="img-fluid" /></a>
  </div>
  </div>
