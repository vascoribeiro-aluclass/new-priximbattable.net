...
<div class="form-group row {if !empty($field.errors)}has-error{/if}">
  ...
  <div class="col-md-4 form-control-valign">
  <input
  class="form-control"
  name="{$field.name}"
  type="{$field.type}"
...
{else if $field.name == 'lastname'}
    ...
    <label class="col-md-1 form-control-label{if $field.required} required{/if}">
        {$field.label}
    </label>
    <div class="col-md-4  form-control-valign">
      <input
...
{else if $field.name == 'city'}
  ...
  {else if $field.name == 'phone_mobile'}
...
{else}
  ...
  <div class="form-group row {if !empty($field.errors)}has-error{/if}">
    ...
    <div class="identifier col-md-7{if ($field.type === 'radio-buttons')} form-control-valign{/if}">
