 ...
 *}
 {block name='order_messages_table'}
  {if $order.messages}
    <div class="box messages new-layout-order-detail-box">
...
{block name='order_message_form'}
  <section class="order-message-form box new-layout-order-detail-box">
    <form action="{$urls.pages.order_detail}" method="post">
      ...
      <footer class="form-footer text-sm-center">
        ...
        <button type="submit" name="submitMessage" style= "border-radius: 25px;" class="hs-btn btn btn-primary form-control-submit">
