        ...
        {foreach from=$orders item=order}
          <tr>
            ...
            <td class="text-sm-center order-actions">
              <a style= "border-radius: 25px;" href="{$order.details.details_url}" data-link-action="view-order-details" class="btn btn-primary btn-sm">
                {l s='Details' d='Shop.Theme.Customeraccount'}
              </a>
              {if $order.details.reorder_url}
                <a style= "border-radius: 25px;" href="{$order.details.reorder_url}" class="btn btn-primary btn-sm">{l s='Reorder' d='Shop.Theme.Actions'}</a>
              {/if}

              {assign var='hashtracking' value=Customer::trackingOrderGoldylocks({$order.details.reference})}
              <a style= "border-radius: 25px;" href="https://gestao.eu/?order={$hashtracking}" target="_blank" class="btn btn-primary btn-sm">Suivi de commande</a>
        ...
        <div class="order">
          <div class="row">
            ...
            <div class="col-xs-2 text-xs-right">
                ...
                <div>
                  {assign var='hashtracking' value=Customer::trackingOrderGoldylocks({$order.details.reference})}
                  <a href="https://commandes.priximbattable.net/?order={$hashtracking}" target="_blank">
                    <i class="material-icons">&#xe558;</i>
                  </a>
                </div>
                <div>
