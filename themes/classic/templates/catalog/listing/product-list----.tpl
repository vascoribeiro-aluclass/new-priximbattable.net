          ...
          {foreach from=$subcategories item=subcategory}
            <div class="col-md-4 ">
              <div class="subcategories-box">
                ...
                <span class="h4 subcategory-name" style="height: 60px;">
                  <a class="h4"
      ...
      <div class="container">
          ...
          <div class="hidden-md-down" style="flex-direction: row;display: inline-flex;">
            <div style="width: 35.2%; margin-right: 0.4rem;">
              <a href="https://priximbattable.net/content/49-il-y-a-un-produit-prix-imbattable-pres-de-chez-vous"
                target="_blank">
                <img src="/img/comparatif/desktop/FR_desktopLocale.jpg" alt="" class="img-fluid imgBannerDesktop" />
              </a>
            </div>
            <div style="width: 35.2%; margin-right: 0.4rem;">
              <a href="https://priximbattable.net/comparatif?ctg=45" target="_blank">
                <img src="/img/comparatif/desktop/FR_desktop_portoesv2.jpg" alt="" class="img-fluid imgBannerDesktop" />
              </a>
            </div>
            <div class="imgPDF" style="width: 29.4%; cursor: pointer;">
              <img src="/img/comparatif/FR_desktop_pdfv2.jpg" alt="" class="img-fluid  imgBannerDesktop" />
            </div>
          </div>
              ...
              <div class="col-sm-12" id="imgBanner">
                <div class="row" style="background: #f1f1f1;">
                  <div class="col-sm-12" style="margin-bottom: 0.4rem;">
                    <a href="https://priximbattable.net/content/49-il-y-a-un-produit-prix-imbattable-pres-de-chez-vous"
                      target="_blank">
                      <img src="/img/comparatif/desktop/FR_desktopLocale.jpg" alt="" class="img-fluid imgBannerMobile" />
                    </a>
                  </div>
                  <div class="col-sm-12" style="margin-bottom: 0.4rem;">
                    <a href="https://priximbattable.net/comparatif?ctg=45" target="_blank">
                      <img src="/img/comparatif/desktop/FR_desktop_portoesv2.jpg" alt=""
                        class="img-fluid imgBannerMobile" />
                    </a>
                  </div>
                  <div class="col-sm-12 imgPDF" style="cursor: pointer;">
                    <img src="/img/comparatif/FR_desktop_pdfv2.jpg" alt="" class="img-fluid imgBannerMobile" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="hidden-md-down" style="flex-direction: row;display: inline-flex;">
            ...
            <div style="width: 35.2%; margin-right: 0.4rem;">
              <a href="https://priximbattable.net/comparatif?ctg=34" target="_blank">
                <img src="/img/comparatif/desktop/FR_desktop_pergolaAluminiov2.jpg" alt=""
                  class="img-fluid imgBannerDesktop" />
              </a>
            </div>
            <div class="imgPDF" style="width: 29.4%; cursor: pointer;">
              <img src="/img/comparatif/FR_desktop_pdfv2.jpg" alt="" class="img-fluid  imgBannerDesktop" />
          ...
          <div class="hidden-md-down" style="flex-direction: row;display: inline-flex;">
            ...
            <div style="width: 35.2%; margin-right: 0.4rem;">
              <a href="https://priximbattable.net/comparatif?ctg=35" target="_blank">
                <img src="/img/comparatif/desktop/FR_desktop_pergolaBioclimaticav2.jpg" alt=""
                  class="img-fluid imgBannerDesktop" />
              </a>
            </div>
            <div class="imgPDF" style="width: 29.4%; cursor: pointer;">
          ...
          <div class="hidden-md-down" style="flex-direction: row;display: inline-flex;">
            ...
            <div style="width: 35.2%; margin-right: 0.4rem;">
              <a href="https://priximbattable.net/comparatif?ctg=21" target="_blank">
                <img src="/img/comparatif/desktop/FR_desktop_cloturev2.jpg" alt="" class="img-fluid imgBannerDesktop" />
              </a>
            </div>
            <div class="imgPDF" style="width: 29.4%; cursor: pointer;">
              <img src="/img/comparatif/FR_desktop_pdfv2.jpg" alt="" class="img-fluid  imgBannerDesktop" />
            ...
            <div class="row">
              <div class="col-sm-12" id="imgBanner">
                <div class="row" style="background: #f1f1f1;">
                  ...
                  <div class="col-sm-12" style="margin-bottom: 0.4rem;">
                    <a href="https://priximbattable.net/comparatif?ctg=21" target="_blank">
                      <img src="/img/comparatif/desktop/FR_desktop_cloturev2.jpg" alt=""
                        class="img-fluid imgBannerMobile" />
                    </a>
                  </div>
                  <div class="col-sm-12 imgPDF" style="cursor: pointer;">
          ...
          <div class="hidden-md-down" style="flex-direction: row;display: inline-flex;">
            ...
            <div style="width: 35.2%; margin-right: 0.4rem;">
              <a href="https://priximbattable.net/comparatif?ctg=23" target="_blank">
                <img src="/img/comparatif/desktop/FR_desktop_gardeCorpsv2.jpg" alt=""
                  class="img-fluid imgBannerDesktop" />
              </a>
            </div>
            <div class="imgPDF" style="width: 29.4%; cursor: pointer;">
          ...
          <div class="hidden-md-down" style="flex-direction: row;display: inline-flex;">
            ...
            <div style="width: 35.2%; margin-right: 0.4rem;">
              <a href="https://priximbattable.net/comparatif?ctg=25" target="_blank">
                <img src="/img/comparatif/desktop/FR_desktop_porteGarageBattantv2.jpg" alt=""
                  class="img-fluid imgBannerDesktop" />
              </a>
            </div>
            <div class="imgPDF" style="width: 29.4%; cursor: pointer;">
          ...
          <div class="hidden-md-down" style="flex-direction: row;display: inline-flex;">
            ...
            <div style="width: 35.2%; margin-right: 0.4rem;">
              <a href="https://priximbattable.net/comparatif?ctg=26" target="_blank">
                <img src="/img/comparatif/desktop/FR_desktop_portaGaragemEnrolavelv2.jpg" alt=""
                  class="img-fluid imgBannerDesktop" />
              </a>
            </div>
            <div class="imgPDF" style="width: 29.4%; cursor: pointer;">
        ...
        {elseif {$category.id} == "24" }
          <div class="hidden-md-down" style="flex-direction: row;display: inline-flex;">
            ...
            <div style="width: 35.2%; margin-right: 0.4rem;">
              <a href="https://priximbattable.net/comparatif?ctg=24" target="_blank">
                <img src="/img/comparatif/desktop/FR_desktop_portaGaragemSecv2.jpg" alt=""
                  class="img-fluid imgBannerDesktop" />
              </a>
            </div>
            <div class="imgPDF" style="width: 29.4%; cursor: pointer;">
          ...
          <div class="hidden-md-down" style="flex-direction: row;display: inline-flex;">
            ...
            <div style="width: 35.2%; margin-right: 0.4rem;">
              <a href="https://priximbattable.net/comparatif?ctg=33" target="_blank">
                <img src="/img/comparatif/desktop/FR_desktop_portaServv2.jpg" alt="" class="img-fluid imgBannerDesktop" />
              </a>
            </div>
            <div class="imgPDF" style="width: 29.4%; cursor: pointer;">
              <img src="/img/comparatif/FR_desktop_pdfv2.jpg" alt="" class="img-fluid  imgBannerDesktop" />
            ...
            <div class="row">
              <div class="col-sm-12" id="imgBanner">
                <div class="row" style="background: #f1f1f1;">
                  ...
                  <div class="col-sm-12" style="margin-bottom: 0.4rem;">
                    <a href="https://priximbattable.net/comparatif?ctg=33" target="_blank">
                      <img src="/img/comparatif/desktop/FR_desktop_portaServv2.jpg" alt=""
                        class="img-fluid imgBannerMobile" />
                    </a>
                  </div>
                  <div class="col-sm-12 imgPDF" style="cursor: pointer;">
        ...
        {elseif {$category.id} == "20" || {$category.id} == "22" || {$category.id} == "27" || {$category.id} == "28" ||
          ...
          {$category.id} == "174" }
          <div class="hidden-md-down" style="flex-direction: row;display: inline-flex;">
            <div style="width: 60.5%; margin-right: 0.4rem;">
              <a href="https://priximbattable.net/content/49-il-y-a-un-produit-prix-imbattable-pres-de-chez-vous"
                target="_blank">
                <img src="/img/comparatif/desktop/FR_desktopLocaleDuplo.jpg" alt="" class="img-fluid imgBannerDesktop" />
              </a>
            </div>
