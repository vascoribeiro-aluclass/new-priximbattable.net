...
<div class="imageCate">
  <div class="container">
    ...
    <img itemprop="image" src="/img/logo-qualite-prix.png" alt="Qualité prix" title="Qualité prix"></div>
    ...
    <div class="video-responsive col-md-9 col-sm-6 col-xs-12">
        ...
        <iframe class="embed-responsive-item"  height="200" src="https://www.youtube.com/embed/E5a-WW8C5l4" allowfullscreen></iframe>
        </div>
 {elseif $page.body_classes|classnames|strstr:'category-id-parent-105' || $page.body_classes|classnames|strstr:'category-id-105'}
        <div class="embed-responsive embed-responsive-16by9">
		  <iframe class="embed-responsive-item"  height="300" src="https://www.youtube.com/embed/5QlufnX76rA" allowfullscreen></iframe>
        </div>
        ...
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item"  height="200" src="https://www.youtube-nocookie.com/embed/CS0SAKka_NM" allowfullscreen></iframe>
        </div>
        {elseif $page.body_classes|classnames|strstr:'category-id-parent-126' || $page.body_classes|classnames|strstr:'category-id-126'}
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item"  height="200" src="https://www.youtube-nocookie.com/embed/Jm6cYLvxH9k" allowfullscreen></iframe>
        </div>
        ...
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item"  height="200" src="https://www.youtube-nocookie.com/embed/H3HeVw3tvXQ" allowfullscreen></iframe>
        </div>
        {elseif $page.body_classes|classnames|strstr:'category-id-parent-10' || $page.body_classes|classnames|strstr:'category-id-10'}
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item"  height="200" src="https://www.youtube-nocookie.com/embed/tLQupk-Q6rw" allowfullscreen></iframe>
        </div>
        {elseif $page.body_classes|classnames|strstr:'category-id-parent-10' || $page.body_classes|classnames|strstr:'category-id-10'}
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item"  height="200" src="https://www.youtube-nocookie.com/embed/tLQupk-Q6rw" allowfullscreen></iframe>
        ...
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item"  height="200" src="https://www.youtube-nocookie.com/embed/BxUoMtvd-CQ" allowfullscreen></iframe>
        </div>
        {elseif $page.body_classes|classnames|strstr:'category-id-parent-9' || $page.body_classes|classnames|strstr:'category-id-9'}
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item"  height="200" src="https://www.youtube-nocookie.com/embed/uxR-YOyAjC0" allowfullscreen></iframe>
        </div>
        ...
        <div class="embed-responsive embed-responsive-16by9">
			<iframe class="embed-responsive-item"  height="200" src="https://www.youtube-nocookie.com/embed/5QlufnX76rA" allowfullscreen></iframe>
        </div>
                              ...
                              <a href="{$link->getCategoryLink($subcategory.id_category, $subcategory.link_rewrite)|escape:'html':'UTF-8'}" title="{$subcategory.name|escape:'html':'UTF-8'}" class="img">
                                ...
                                {if {$subcategory.id_category} == "67"}
                                  {if $subcategory.id_image}
                                    <img class="replace-2x" style="height: 132px !important;" src="{$link->getCatImageLink($subcategory.link_rewrite, $subcategory.id_image)}" alt="" />
                                  {else}
                                    <img class="replace-2x" style="height: 132px !important;" src="{$img_cat_dir}en-default-category_default.jpg" alt=""  />
                                  {/if}
                                {else}
                                  {if $subcategory.id_image}
