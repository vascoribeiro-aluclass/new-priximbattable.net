      ...
      {block name='product_thumbnail'}
        {if $product.cover}
          <a href="{$product.url}" class="thumbnail product-thumbnail">
            <div class="img-a-medida img-a-medida-hide" data-divname="{$product.name}">
              <img src="/img/cms/fr-regua.png" alt="">
            </div>
            <div class="img-a-promo img-a-medida-hide" data-divname="{$product.name}">
              <img src="/img/cms/promo.png" alt="">
            </div>
            <div class="img-a-top-prix img-a-medida-hide" data-divname="{$product.name}">
              <img src="/img/cms/top-prix.png" alt="">
            </div>
            <div class="img-cloture-100 img-a-medida-hide" data-dividprod="{$product.id_product}">
              <img src="/img/cms/img-cloture-100.png" alt="">
            </div>
            <div class="img-cloture-200-4mm img-a-medida-hide" data-dividprod="{$product.id_product}">
              <img src="/img/cms/img-cloture-200-4mm.png" alt="">
            </div>
            <div class="img-cloture-200-5mm img-a-medida-hide" data-dividprod="{$product.id_product}">
              <img src="/img/cms/img-cloture-200-5mm.png" alt="">
            </div>
            <img
      ...
      <div class="product-description">
        ...
        {block name='product_price_and_shipping'}
          {if $product.show_price}
            <div class="pb-1 pt-1 product-price-and-shipping" style="margin-top: -5px; background-color: #FFF;">
            {if $product.has_discount}
                {hook h='displayProductPriceBlock' product=$product type="old_price"}

                <span class="sr-only">{l s='Regular price' d='Shop.Theme.Catalog'}</span>
                {* <span class="regular-price">{$product.regular_price}</span> *}
                {* {if {$product.id_product} == '3659'} *}
                {assign var='infoProduto' value=Product::infoProduto({$product.id}, {$product.price_amount}, {$product.price_tax_exc})}
                  <span class="regular-price">{$infoProduto['preco_corrigido']}</span>
