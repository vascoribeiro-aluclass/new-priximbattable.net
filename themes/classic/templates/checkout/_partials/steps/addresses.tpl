 ...
 *}
 ...
 {block name='step_content'}
   <div class="js-address-form">
     <form
       method="POST" action="{$urls.pages.order}?shipfree={if $shipfree == 3}0{else}{$shipfree}{/if}"
     ...
     >
       ...
       {elseif $customer.addresses|count > 0}
         ...
         {if $use_same_address && !$cart.is_virtual}
           <p>
             <a data-link-action="different-invoice-address" href="{$use_different_address_url}&shipfree=3" class="btn btn-success" style="color: white;">
       ...
       <div class="row">
          <div class="col-lg-12 pl-0 pr-0 pt-2">
            <picture>
              <source srcset="/img/cms/fabricant/banner-camionnettes.webp" type="image/webp">
              <img loading="lazy" src="/img/cms/fabricant/banner-camionnettes.jpg" class="img-fluid" alt="Avis" title="Avis" width="1450" height="430">
            </picture>
          </div>
