      ...
      <footer class="address-footer">
        {if $interactive}
          <a
            ...
            href="{url entity='order' params=['id_address' => $address.id, 'editAddress' => $type, 'token' => $token, 'shipfree' => '3']}"
          >
          ...
          <a
            ...
            href="{url entity='order' params=['id_address' => $address.id, 'deleteAddress' => true, 'token' => $token, 'shipfree' => '3']}"
          >
