            ...
            if (!count($this->errors)) {
                ...
                if (Validate::isLoadedObject($order) && $order->id_customer == $this->context->customer->id) {
                    ...
                    if (Validate::isLoadedObject($customer)) {
                      ...
                      $result_address = Db::getInstance()->executeS("SELECT
                          CASE
                      ...
                      $sql = "INSERT INTO `sc_rappel`
                      (`sc_rappel_nom`,`sc_rappel_tel`,`sc_rappel_email`,`sc_rappel_type`,`sc_rappel_message`)
                      VALUES ('".$customer->lastname." ".$customer->firstname."','". $row_address['phone']."','".$customer->email."','email','Referenz der Bestellung : ".$order->reference."<br><br> Produkt : ".$product_name." <br><br> ".Tools::nl2br($msgText)."'); ";
